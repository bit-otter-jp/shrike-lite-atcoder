...
def setup_hardware():
    ...
    print("WORK5_SETUP BITSTREAM={} ACTION=FLASH".format(BITSTREAM))
    shrike.reset()
    ...
    print("WORK5_SETUP RESULT=READY SPI_HZ={}".format(spi_baudrate))
...
def main():
    ...
    print(
        "WORK5_DONE PLAN={} PASS={} FAIL={} TOTAL={} RESULT={}".format(
            RUN_PLAN,
            total_passed,
            total_failed,
