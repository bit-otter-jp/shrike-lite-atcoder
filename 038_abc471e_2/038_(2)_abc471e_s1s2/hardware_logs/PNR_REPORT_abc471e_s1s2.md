######################################################################
8/17/26 1:10 PM > Launching Place-and-Route tool
######################################################################
...
Opened I/O file C:/Users/tkomy/AppData/Local/Temp/BlbflLqN/config/io_spec_in.txt for reading.
Full I/O locations after placement are in I/O file PNR_IO.log
Reading file C:/Users/tkomy/AppData/Local/Temp/BlbflLqN/config/netlist.edif.
...
32 LUTs reduced and 0 LUTs removed with VDD/GND/BUF/DUP propagation, 4 LUTs reduced with input sensitivity analysis.
...
Warning: User IO g_3357_spi_ss_n_ibuf is driving data and control signals at the same time, this cannot be packed into IOB FF.
Warning: User IO g_3357_spi_ss_n_ibuf is not packed with an IOB FF. This may cause potential interface timing issues.
Warning: User IO g_3354_spi_miso_en_obuf is not packed with an IOB FF. This may cause potential interface timing issues.
Warning: User IO g_3352_rst_n_ibuf is not packed with an IOB FF. This may cause potential interface timing issues.
...
Net 2: clk, is a clock net.
     ...
     621 new instances packed into  128 CLBs after carry-chain packing.
       0 new instances packed into  128 CLBs after RAM_SRL packing
Complete design-rule-driven LUT packing.

Starting CLB clustering for remaining instances...
      10 new instances packed into  138 CLBs after ROM/MUXF packing
       0 new instances clustered into    0 clusters after MUXF/ROM clustering, CLB count 138
    2814 new instances clustered into 1936 clusters after LUT clustering
      40 new instances packed into  138 CLBs after LUT cluster-packing
      44 new instances clustered into 1980 clusters after FF clustering
...
Starting timing-driven LUT packing...
     269 new instances packed into  202 CLBs after stage 1 timing-driven LUT packing
      51 new instances packed into  220 CLBs after stage 2 timing-driven LUT packing
     113 new instances packed into  252 CLBs after stage 3 timing-driven LUT packing
     271 new instances packed into  295 CLBs after stage 4 timing-driven LUT packing
     308 new instances packed into  385 CLBs after stage 5 timing-driven LUT packing
     198 new instances packed into  420 CLBs after stage 6 timing-driven LUT packing
     550 new instances packed into  420 CLBs after stage 7 connectivity-timing-driven LUT packing
    1111 new instances packed into  567 CLBs after final connectivity-timing-driven LUT packing
   0 instances remain unpacked
Complete LUT packing.

Verifying packed netlist against original, unpacked netlist...
Packing verified: 1
Runtime of packing: 0:0:4(CPU time), 0:0:4(real time)
...
####   Resource Utilization Report   ####
    ...
    Resource usage:
     561 Logic 6-LUT CLBs
         2114 CLB LUTs utilized (up to 4 per CLB)
               420 of which are 6-input LUTs
               381 of which are dual 5-input LUTs
              2495 LUTs total
          823 CLB FFs utilized (up to 4 pairs per CLB)
               823 of which are LUT-FF combination
               109 of which are dual-FFs
                93 of which are dual-LUT-dual-FF combination
               932 FFs total
       6 I/O CLBs
            4  Input pins
       ...
       1 Clock
           Clock 0: net     2, clk, Fanout: 355 CLBs
...
RUN_FPGA_PLACER_DONE 1 b3f2ba84
...
Usage of Logic CLBs is 400.7%.
    Logic-Memory CLB for RAM/Shift-Register is 0.0%.
Usage of LUTs is 377.5%.
    dual-LUTs is 68.0%.
Usage of FF is 147.0%.
    dual-FF is 19.5%.
...
There are 569 instances. After combining instances in chains, there are 469 instances to place.
There are 2420 nets in the design, 20 of which have fanout larger than 49. Average fanout is 3.00.
There is 1 clock in the design.
Resource usages:
 Type=L: Capacity=140 Utilized=561 NumInst=463. [ChainLen=1]=442 [ChainLen=2]=5 [ChainLen=3]=4 [ChainLen=8]=11 [ChainLen=9]=1
 Type=M: Capacity=40 Utilized=0 NumInst=0.
 Type=IOB: Capacity=184 Utilized=6 NumInst=6.
 Resource over-use on combined types=L,M: Capacity=140,- Utilized=561,0, NumInst=463,0
...
######################################################################
8/17/26 1:10 PM > Place-and-Route tool failed
######################################################################
