(* top *) module main (
    ...
    reg  [29:0] mod_arith_a;
    reg  [29:0] mod_arith_b;
    reg         mod_arith_sub;
    reg         mod_arith_reduce;
    wire [29:0] mod_arith_b_selected =
        mod_arith_b ^ {30{mod_arith_sub}};
    wire [30:0] mod_arith_sum =
        {1'b0, mod_arith_a} + {1'b0, mod_arith_b_selected} +
        {{30{1'b0}}, mod_arith_sub};
    wire [30:0] mod_arith_reduced =
        (mod_arith_sum >= {1'b0, MOD}) ?
        (mod_arith_sum - {1'b0, MOD}) : mod_arith_sum;
    wire [29:0] mod_arith_result = mod_arith_reduce ?
        mod_arith_reduced[29:0] : mod_arith_sum[29:0];
    ...
    // datapath and takes the wrapped low 30 bits.
    always @(*) begin
        mod_arith_a      = 30'd0;
        mod_arith_b      = 30'd0;
        mod_arith_sub    = 1'b0;
