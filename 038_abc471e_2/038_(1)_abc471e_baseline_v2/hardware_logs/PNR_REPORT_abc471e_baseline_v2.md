######################################################################
8/17/26 12:30 PM > Launching Place-and-Route tool
######################################################################
...
Opened I/O file C:/Users/tkomy/AppData/Local/Temp/zqrNyyIF/config/io_spec_in.txt for reading.
Full I/O locations after placement are in I/O file PNR_IO.log
Reading file C:/Users/tkomy/AppData/Local/Temp/zqrNyyIF/config/netlist.edif.
...
Warning: User IO g_3418_spi_ss_n_ibuf is driving data and control signals at the same time, this cannot be packed into IOB FF.
Warning: User IO g_3418_spi_ss_n_ibuf is not packed with an IOB FF. This may cause potential interface timing issues.
Warning: User IO g_3415_spi_miso_en_obuf is not packed with an IOB FF. This may cause potential interface timing issues.
Warning: User IO g_3413_rst_n_ibuf is not packed with an IOB FF. This may cause potential interface timing issues.
...
Net 2: clk, is a clock net.
     ...
     617 new instances packed into  127 CLBs after carry-chain packing.
       0 new instances packed into  127 CLBs after RAM_SRL packing
Complete design-rule-driven LUT packing.

Starting CLB clustering for remaining instances...
       0 new instances clustered into    0 clusters after MUXF/ROM clustering, CLB count 127
    2908 new instances clustered into 1960 clusters after LUT clustering
       0 new instances packed into  127 CLBs after LUT cluster-packing
      44 new instances clustered into 2004 clusters after FF clustering
...
Starting timing-driven LUT packing...
     654 new instances packed into  232 CLBs after stage 1 timing-driven LUT packing
Note: pack_timing_cluster_find_candidate inst 740 has already_packed=25 and clustering_index=-1
      54 new instances packed into  245 CLBs after stage 2 timing-driven LUT packing
      53 new instances packed into  263 CLBs after stage 3 timing-driven LUT packing
     120 new instances packed into  305 CLBs after stage 4 timing-driven LUT packing
     262 new instances packed into  357 CLBs after stage 5 timing-driven LUT packing
     334 new instances packed into  454 CLBs after stage 6 timing-driven LUT packing
     618 new instances packed into  454 CLBs after stage 7 connectivity-timing-driven LUT packing
     874 new instances packed into  577 CLBs after final connectivity-timing-driven LUT packing
...
####   Resource Utilization Report   ####
    ...
    Resource usage:
     571 Logic 6-LUT CLBs
         2157 CLB LUTs utilized (up to 4 per CLB)
               423 of which are 6-input LUTs
               342 of which are dual 5-input LUTs
              2499 LUTs total
          880 CLB FFs utilized (up to 4 pairs per CLB)
               879 of which are LUT-FF combination
               112 of which are dual-FFs
                95 of which are dual-LUT-dual-FF combination
               992 FFs total
       6 I/O CLBs
            4  Input pins
       ...
       1 Clock
           Clock 0: net     2, clk, Fanout: 354 CLBs
...
RUN_FPGA_PLACER_DONE 1 452fbfd4
...
Usage of Logic CLBs is 407.9%.
    Logic-Memory CLB for RAM/Shift-Register is 0.0%.
Usage of LUTs is 385.2%.
    dual-LUTs is 61.1%.
Usage of FF is 157.1%.
    dual-FF is 20.0%.
...
There are 579 instances. After combining instances in chains, there are 480 instances to place.
There are 2433 nets in the design, 21 of which have fanout larger than 49. Average fanout is 3.05.
There is 1 clock in the design.
Resource usages:
 Type=L: Capacity=140 Utilized=571 NumInst=474. [ChainLen=1]=453 [ChainLen=2]=5 [ChainLen=3]=4 [ChainLen=8]=12
 Type=M: Capacity=40 Utilized=0 NumInst=0.
 Type=IOB: Capacity=184 Utilized=6 NumInst=6.
 Resource over-use on combined types=L,M: Capacity=140,- Utilized=571,0, NumInst=474,0
...
######################################################################
8/17/26 12:30 PM > Place-and-Route tool failed
######################################################################
